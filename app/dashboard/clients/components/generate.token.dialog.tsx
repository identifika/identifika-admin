                                ...
                                case Status.SUCCESS:
                                    return (
                                        <div className="flex flex-col gap-4 mt-4 max-w-md">
                                            ...
                                            <div className="flex items-center justify-center w-1/2 px-2 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-green-500 rounded-lg shrink-0 sm:w-auto gap-x-2 hover:bg-green-600 dark:hover:bg-green-500 dark:bg-green-600 mt-4">
                                                <IoCopy className="w-5 h-5" />
                                                <span onClick={onCopy}>Copy Token</span>
                                            </div>
                                        </div>
                                    )
                                case Status.ERROR:
