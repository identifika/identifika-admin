...
export default function UserSearchComponent(props: UserSearchComponentProps) {
    ...
    function onSearchFunction(e: any) {
        ...
        router.push(`/dashboard/users?page=${props.page}&limit=${props.limit}&search=${search}`)
            ...
            <div className="relative flex items-center mt-4 md:mt-0 justify-between">
                ...
                <button
                    onClick={() => {
                        ...
                        router.push(`/dashboard/users?page=${props.page}&limit=${props.limit}`)
                    }}
